...
if __name__ == "__main__":
    ...
    subPlot(ax[1], time, get_sub_states(original_system_states, 1), get_sub_states(ref_states, 1), ylabel='Y position')
    subPlot(ax[2], time, get_sub_states(new_system_states, 0), get_sub_states(ref_states, 0), ylabel='X after tuning')
    subPlot(ax[3], time, get_sub_states(new_system_states, 1), get_sub_states(ref_states, 1), ylabel='Y after tuning')
